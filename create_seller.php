...
<div class="container-fluid text-center" id="content">
	<div class="row content">
	  ...
	  <!-- ALL CONTENT GOES INSIDE THIS DIV -->
	  	  <h1 class="page-title">Create A Seller</h1>
			...
			?>
	  	  	...
	  	  	<!-- Create Seller form -->
	  	  	<form id="seller-form" class="edit-form" method="post" action="create_seller.php" onsubmit="return validateForm(this)">
			<fieldset>
			...
			<table align="center">
				<tr>
					<td><input type="submit" value="Create Seller"></td>
				</tr>
			</table>
			...
			$("#seller-form").validate();
	  	  	...
	  	  	<?php
					...
					// Else, try to create the seller
	
					$query = "INSERT INTO Seller VALUES (seller_seq.nextval, :fname, :lname, :address, :suburb, :state, :phone, :mobile, :email, :mailinglist)";
					...
					if (@oci_execute($stmt)) {
						...
						echo "<p>";
						echo "The seller '".$_POST["fname"]."' '".$_POST["lname"]."'  was successfully created.";
						echo "</p>";
						echo "<p><a href='sellers.php'>Return to Seller Page</a></p>";
					} else {
						// If the insert failed
						echo "<p>";
						echo "Error: the seller could not be inserted.";
						echo "</p>";
						echo "<p><a href='sellers.php'>Return to Seller Page</a></p>";
					}
				}
