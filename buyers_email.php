...
// 
$query = "SELECT * FROM Buyer WHERE BUYER_MAILING = 'Y'";
...
<div class="container-fluid text-center" id="content">
  ...
  <?php
    ...
    {
 ?>
      <form method="post" action="buyers_email.php">
...
<a href="display_source.php?page=buyers_email.php" target="_blank"><img src="images/client.png" alt="client"/></a>
